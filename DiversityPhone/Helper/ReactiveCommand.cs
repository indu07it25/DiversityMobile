namespace DiversityPhone.ViewModels
{
    ...
    public class ReactiveCommand<T> : ObservableBase<T>, ICommand where T : class
    {
        ...
        public ReactiveCommand(Func<T, bool> canExecute, IObservable<Unit> canExecuteChanged = null, IScheduler scheduler = null)
        {
            inner_command = ReactiveCommand.Create(create_can_execute(canExecute), scheduler: scheduler);
